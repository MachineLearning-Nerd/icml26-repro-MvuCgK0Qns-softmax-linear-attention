...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_f29910ce620b", "created_at": "2026-07-16T16:20:13+00:00", "title": "Independent, fail-closed protocol"}
-->
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_1197eb085b7a", "created_at": "2026-07-16T16:20:14+00:00", "title": "Complete CPU reproduction bundle", "artifact": "softmax-linear-attention-repro/softmax-linear-attention-cpu-reproduction:v0", "artifact_type": "dataset"}
-->
**📦 Artifact** `softmax-linear-attention-repro/softmax-linear-attention-cpu-reproduction:v0` · dataset

https://huggingface.co/buckets/DineshAI/MvuCgK0Qns-artifacts#softmax-linear-attention-repro/softmax-linear-attention-cpu-reproduction:v0


---
<!-- trackio-cell
{"type": "code", "id": "cell_8f304ac524d5", "created_at": "2026-07-16T16:20:49+00:00", "title": "Full clean-room reproduction", "command": [".venv/bin/python", "reproduction/reproduce.py", "--output-dir", "outputs/full"], "exit_code": 0, "duration_s": 24.012}
-->
````bash
...
````output
{
  ...
  "claim_1": {
    "verdict": "verified",
    "quadrature_cases": 48,
    "max_quadrature_abs_error": 1.27675647831893e-15,
    "rademacher_negative_control": {
      "z": 2.0,
      "rademacher_output": 0.9640275800758169,
      "gaussian_affine_prediction": 2.0,
      "absolute_residual": 1.035972419924183
    },
    "finite_output_reductions": {
      "isotropic": 76.94737920479254,
      "rotated_condition_8": 41.3524767987845,
      "toeplitz_rho_0.5": 44.222672042975205
    }
  },
  "claim_2": {
    "verdict": "verified",
    "query_metric_comparisons": 18144,
    "rate_slope_min": -1.1088146455990573,
    "rate_slope_max": -0.8316763328439224,
    "rate_r_squared_min": 0.9551631355788126,
    "trajectory_checkpoints": 24,
    "long_prompt_gradient_wins": 24
  },
  "claim_3": {
    "verdict": "verified",
    "trained_models": 36,
    "trained_reductions": {
      "isotropic": {
        "trained_risk_reduction_L16_to_L1024": 53.86273154631195,
        "parameter_distance_reduction_L16_to_L1024": 20.045129149990846
      },
      "rotated_condition_8": {
        "trained_risk_reduction_L16_to_L1024": 43.91019487788107,
        "parameter_distance_reduction_L16_to_L1024": 206.37885217210552
      },
      "toeplitz_rho_0.5": {
        "trained_risk_reduction_L16_to_L1024": 44.28132032279648,
        "parameter_distance_reduction_L16_to_L1024": 107.81784871780192
      }
    },
    "bayes_risk_reductions": {
      "isotropic": 263.21637763065297,
      "rotated_condition_8": 248.0909901962841,
      "toeplitz_rho_0.5": 232.1195796022963
    },
    "max_bayes_operator_identity_error": 9.87213553952913e-17,
    "max_infinite_bayes_risk": 1.3518530658218422e-32
  },
  "compute": {
    "wall_seconds": 23.259566236985847,
    "cpu_only": true,
    "gpu_used": false,
    "python": "3.12.13",
    "numpy": "2.3.5",
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_b95ce75e2c5a", "created_at": "2026-07-16T16:20:50+00:00", "title": "Eight fail-closed tests", "command": [".venv/bin/python", "-m", "unittest", "-v", "reproduction/test_reproduction.py"], "exit_code": 0, "duration_s": 0.766}
-->
````bash
...
````output
test_analytic_jacobians_against_finite_differences (reproduction.test_reproduction.ReproductionTests.test_analytic_jacobians_against_finite_differences) ... ok
test_complete_cpu_outputs (reproduction.test_reproduction.ReproductionTests.test_complete_cpu_outputs) ... ok
test_exact_bayes_transfer (reproduction.test_reproduction.ReproductionTests.test_exact_bayes_transfer) ... ok
test_gaussian_affine_identity (reproduction.test_reproduction.ReproductionTests.test_gaussian_affine_identity) ... ok
test_gradient_stability_along_trajectory (reproduction.test_reproduction.ReproductionTests.test_gradient_stability_along_trajectory) ... ok
test_non_gaussian_boundary (reproduction.test_reproduction.ReproductionTests.test_non_gaussian_boundary) ... ok
test_output_and_jacobian_concentration (reproduction.test_reproduction.ReproductionTests.test_output_and_jacobian_concentration) ... ok
test_trained_models_approach_linear_solution (reproduction.test_reproduction.ReproductionTests.test_trained_models_approach_linear_solution) ... ok
