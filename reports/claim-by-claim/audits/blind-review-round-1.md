...
|---|---|---|---|---|
| 1 | Yes | No | MISSING | evidence/claim_1/EVAL.md; evidence/claim_1/command.txt; evidence/claim_1/environment.md; evidence/claim_1/independent_check.py; evidence/claim_1/limitations.md; evidence/claim_1/method.md; evidence/claim_1/negative_control.py; evidence/claim_1/source_audit.md; evidence/claim_1/verifier_output.txt |
| 2 | Yes | No | MISSING | evidence/claim_2/EVAL.md; evidence/claim_2/command.txt; evidence/claim_2/environment.md; evidence/claim_2/limitations.md; evidence/claim_2/method.md; evidence/claim_2/source_audit.md; evidence/claim_2/verifier_output.txt |
| 3 | Yes | No | MISSING | evidence/claim_3/EVAL.md; evidence/claim_3/command.txt; evidence/claim_3/environment.md; evidence/claim_3/limitations.md; evidence/claim_3/method.md; evidence/claim_3/source_audit.md; evidence/claim_3/verifier_output.txt |
| 4 | Yes | No | MISSING | evidence/claim_4/EVAL.md; evidence/claim_4/command.txt; evidence/claim_4/environment.md; evidence/claim_4/limitations.md; evidence/claim_4/method.md; evidence/claim_4/source_audit.md; evidence/claim_4/verifier_output.txt |
| 5 | Yes | No | MISSING | evidence/claim_5/EVAL.md; evidence/claim_5/command.txt; evidence/claim_5/environment.md; evidence/claim_5/limitations.md; evidence/claim_5/method.md; evidence/claim_5/source_audit.md; evidence/claim_5/verifier_output.txt |

## Global gates

- PASS — Current verifier is linked directly by README
- FAIL — Historical rejected baseline is reachable
- FAIL — Fixed command is inline
- FAIL — Git SHA and 18/18 result are inline
- FAIL — Actual CPU quota and runtime are inline
...
- `Actual CPU quota and runtime are inline`
- `Fixed command is inline`
...
**Round result: FAIL — fix and repeat.**
